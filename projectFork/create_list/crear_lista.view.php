    ...
    <div class="offset-3 col-6 pt-4 pb-4">
        ...
        <form action="" method="POST" novalidate>
            <div class="form-group">
                <label for="listname">Nombre de la categoría</label>
                <input type="text" class="form-control <?=($errors['listname'])?"is-invalid":""?>" id="listname" name="listname" aria-describedby="listnameHelp" placeholder="Introduce un nombre para la categoría" value="<?=($listname??'')?>">
