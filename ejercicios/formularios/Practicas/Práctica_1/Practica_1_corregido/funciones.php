...
function calcularImporteConsumo($consumo){
    $taxes=[
        FRANJA3 => IMPORTE_MAYOR_FRANJA3,
        FRANJA2 => IMPORTE_MENOR_FRANJA3,
        FRANJA1 => IMPORTE_MENOR_FRANJA2,
        FRANJA0 => IMPORTE_MENOR_FRANJA1
    ];
    foreach ($taxes as $fringe => $multiplier) {
        if( )
    }
    // if($consumo<=FRANJA1){
